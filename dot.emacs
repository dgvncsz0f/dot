...
(setq erc-track-exclude-types (quote ("JOIN" "NICK" "PART" "QUIT" "MODE" "324" "329" "332" "333" "353" "477")))
(setq erc-timestamp-right-align-by-pixel t)
(setq erc-nick (quote ("dsouza" "_dsouza_" "__dsouza__")))
